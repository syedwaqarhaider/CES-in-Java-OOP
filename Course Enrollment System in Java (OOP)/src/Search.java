...
public class Search{
	...
	private void initialize() {
		...
		btnBack.setBounds(434, 520, 109, 39);
		...
		JLabel label_11 = new JLabel("Course Detail");
		label_11.setHorizontalAlignment(SwingConstants.CENTER);
		label_11.setForeground(new Color(51, 51, 255));
		label_11.setFont(new Font("Tahoma", Font.BOLD, 14));
		label_11.setBounds(0, 0, 162, 29);
	...
	/*	JButton btnUpdate = new JButton("Update");
		...
		btnUpdate.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 14));
		btnUpdate.setBounds(310, 520, 109, 39);
	...
	/*	JButton btnDelete = new JButton("Delete");
		...
		btnDelete.setFont(new Font("Arial Rounded MT Bold", Font.BOLD, 14));
		btnDelete.setBounds(564, 520, 109, 39);
